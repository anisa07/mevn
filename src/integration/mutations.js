...
export default {
// update exp state
	setPersonalExperience(state, { data }) {
		const st = state;
		st.experience.experiencePersonal = data;
	},
	setCompanyExperience(state, { data }) {
		const st = state;
		st.experience.experienceCompany = data;
	},
	setSkills(state, { data }) {
		const st = state;
		st.experience.skills = data;
	},
