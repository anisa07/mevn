export default {
	// return exp from state
	getPersonalExperience: state => state.experience.experiencePersonal,
	getCompanyExperience: state => state.experience.experienceCompany,
	getSkills: state => state.experience.skills,
